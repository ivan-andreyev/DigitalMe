...
- [13-PHASE0_IVAN_LEVEL_AGENT.md](MAIN_PLAN/13-PHASE0_IVAN_LEVEL_AGENT.md) - Фаза 0 агента (MVP)
- [13.5-PRODUCTION_READINESS_CREDENTIALS.md](MAIN_PLAN/13.5-PRODUCTION_READINESS_CREDENTIALS.md) - Production readiness и настройка credentials
...
- [21-HYBRID-CODE-QUALITY-RECOVERY-PLAN.md](MAIN_PLAN/21-HYBRID-CODE-QUALITY-RECOVERY-PLAN.md) - План качества кода (hybrid подход)
