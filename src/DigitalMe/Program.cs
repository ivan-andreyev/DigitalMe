...
// Database Context - Configured via DatabaseProviderConfigurator for clean architecture
var tempLogger = builder.Services.BuildServiceProvider().GetService<ILogger<Program>>();
var dbConfigurator = new DigitalMe.Services.Database.DatabaseProviderConfigurator(tempLogger);
dbConfigurator.Configure(builder.Services, builder.Configuration, builder.Environment);
