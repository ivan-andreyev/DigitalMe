...
public class SecretsManagementService : ISecretsManagementService
{
    ...
    {
        return _environment?.IsProduction() == true || _environment?.IsStaging() == true;
    }

    public bool IsTestEnvironment()
    {
        return _environment?.EnvironmentName?.Equals("Testing", StringComparison.OrdinalIgnoreCase) == true;
    }
