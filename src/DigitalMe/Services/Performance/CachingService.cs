...
/// <summary>
/// Focused caching service implementation following ISP compliance.
/// Handles only memory caching operations.
/// </summary>
public class CachingService : ICachingService
{
    ...
    public async Task<T> GetOrSetAsync<T>(string cacheKey, Func<Task<T>> factory, TimeSpan? expiration = null) where T : class
    {
        return await GetOrSetCachedResponseAsync<T>(cacheKey, factory, expiration);
    }
}